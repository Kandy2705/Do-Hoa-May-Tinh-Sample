...
import patch
from patch import Patch, PatchEx
# Import TexturedPatch directly from file
sys.path.insert(0, os.path.join(os.path.dirname(os.path.abspath(__file__)), 'textured'))
from TexturedPatch import TexturedPatch
...
def main():
    ...
    model = Patch(
        ...
        os.path.join(shader_dir, "phong.vert"),
        os.path.join(shader_dir, "phong.frag"),
    ).setup()

    #model = PatchEx(
    #    os.path.join(shader_dir, "phongex.vert"),
    #    os.path.join(shader_dir, "phongex.frag"),
    #).setup()


    model = TexturedPatch(
        os.path.join(shader_dir, "textured", "phong_texture.vert"),
        os.path.join(shader_dir, "textured", "phong_texture.frag"),
    ).setup()
