...
import triangle
from triangle import Triangle, TriangleEx
...
def main():
    ...
    #model = Triangle(os.path.join(shader_dir, "color_interp.vert"), os.path.join(shader_dir, "color_interp.frag")).setup()
    #model = Triangle(os.path.join(shader_dir, "phong.vert"), os.path.join(shader_dir, "phong.frag")).setup()
    #model = Triangle(os.path.join(shader_dir, "gouraud.vert"), os.path.join(shader_dir, "gouraud.frag")).setup()

    model = TriangleEx(os.path.join(shader_dir, "phong.vert"), os.path.join(shader_dir, "phong.frag")).setup()
